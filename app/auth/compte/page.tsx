...
export default function ProfileCard() {
  ...
  useEffect(() => {
    const fetchProfileAndData = async () => {
      ...
      try {
        // Récupérer profil - max 1 résultat (null si aucun)
        ...
        if (profileData.type === "professional") {
          // Récupérer établissements si professionnel
      ...
      <div className="flex flex-col justify-start items-center mt-8 pt-8 md:mt-0 md:ml-8 max-w-md w-full md:mx-48 font-geist">
        {profile.type === "professional" ? (
          <>
            ...
            <Link
              href="/protected/establishment/new"
              className="text-black bg-primary border border-primary px-3 py-2 rounded-md shadow-md hover:text-white mb-4"
            >
          ...
          <>
            ...
            <Link
              href="/protected/spot/new"
              className="text-black hover:text-white mb-4 border border-secondary bg-secondary px-4 py-2 rounded-md"
            >
              Ajouter un spot
            </Link>
